...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-05-2022 a las 12:00:51
...
(4, 'jasaiz01@ucm.es', 1, '0000-00-00', 1, '2022-05-09'),
(5, 'carrito@gmail.com', 1, '0000-00-00', 1, '2022-05-09'),
(6, 'usuario@pizzaguay.com', 4, '2022-05-09', 0, '2022-05-09'),
(8, 'usuario@pizzaguay.com', 4, '2022-05-09', 1, '2022-05-09');
...
('ulises@uli.es', 'ulises', 'ulises', '$2y$10$vc51jvND/PCNRtZoDuLA/.RcXkRjjt8y8ZH.cDpyP03UTo98mem46', 0, 10),
...
--
ALTER TABLE `domicilios`
  MODIFY `ID_Domicilio` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `foro_respuestas`
  MODIFY `ID_Respuesta` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;
...
--
ALTER TABLE `pedidos_bebidas`
  MODIFY `ID_BebidaPedida` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;

--
-- AUTO_INCREMENT de la tabla `pedidos_pizzas`
--
ALTER TABLE `pedidos_pizzas`
  MODIFY `ID_PizzaPedida` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
