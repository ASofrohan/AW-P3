...
class FormularioActualizarPerfil extends Form
{
    public function __construct() {
        parent::__construct('formActualizar');
    }
    ...
    protected function procesaFormulario($datos)
    {
        ...
        if (count($result) === 0) {
            $user = Usuario::edita($nombreUsuario, $nombre, $apellidos, $password2, $calle,$ciudad,$piso,$postal);
            $_SESSION['login'] = true;
